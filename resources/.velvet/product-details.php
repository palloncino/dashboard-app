                                                                ...
                                                                <div class="swiper swiper-preview-details bd-gray-100 product-details-page">
                                                                    <div class="swiper-wrapper">
                                                                        <div class="swiper-slide" id="img-container">
                                                                            <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/ecommerce/png/15.png" alt="img">
                                                                        </div>
                                                                        <div class="swiper-slide image-container">
                                                                            <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/ecommerce/png/13.png" alt="img">
                                                                        </div>
                                                                        <div class="swiper-slide image-container">
                                                                            <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/ecommerce/png/14.png" alt="img">
                                                                        </div>
                                                                        <div class="swiper-slide image-container">
                                                                            <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/ecommerce/png/17.png" alt="img">
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="row g-0 product-scroll rounded-3 p-3 px-0">
                                                        <div class="col-xl-8 mt-xxl-0 mt-3">
                                                            <div>
                                                                ...
                                                                <div class="mb-4">
                                                                    <a href="checkout.php" class="btn btn-secondary me-2 mb-2">Buy Now</a>
                                                                    <a href="cart.php" class="btn btn-success me-2 mb-2">Add To Cart</a>
                                                                </div>
                                                                <div class="mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-2 col my-2">
                                                    <div class="text-center">
                                                        <div class="similar-products-image me-2">
                                                            <img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/png/17.png" alt="">
                                                        </div>
                                                        <h5 class="mb-1 fs-14 fw-semibold   mt-1">Omega Sports shoes series 3</h5>
                                                        <div class="d-flex align-items-center justify-content-center mb-1">
                                                            <h5 class="mb-0 fw-semibold">
