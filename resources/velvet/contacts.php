                                    ...
                                    <div class="card custom-card text-center">
                                        <div class="card-body contact-action">
                                            ...
                                            <div class="align-items-top">
                                                <div class="">
                                                    <div class="avatar avatar-xl avatar-rounded">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-63.jpg" alt="">
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-1 fw-semibold">
                                                            Devon Convoy
                                    ...
                                    <div class="card custom-card text-center">
                                        <div class="card-body contact-action">
                                            ...
                                            <div class="align-items-top">
                                                <div class="">
                                                    <div class="avatar avatar-xl avatar-rounded">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-13.jpg" alt="">
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-1 fw-semibold">
                                                            Tom Holland
                                    ...
                                    <div class="card custom-card text-center">
                                        <div class="card-body contact-action">
                                            ...
                                            <div class="align-items-top">
                                                <div class="">
                                                    <div class="avatar avatar-xl avatar-rounded">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-36.jpg" alt="">
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-1 fw-semibold">
                                                            Anelica Julie
                                    ...
                                    <div class="card custom-card text-center">
                                        <div class="card-body contact-action">
                                            ...
                                            <div class="align-items-top">
                                                <div class="">
                                                    <div class="avatar avatar-xl avatar-rounded">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-8.jpg" alt="">
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-1 fw-semibold">
                                                            Json Taylor
                                    ...
                                    <div class="card custom-card text-center">
                                        <div class="card-body contact-action">
                                            ...
                                            <div class="align-items-top">
                                                <div class="">
                                                    <div class="avatar avatar-xl avatar-rounded">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-34.jpg" alt="">
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-1 fw-semibold">
                                                            Gahaskar Shaik
                                    ...
                                    <div class="card custom-card text-center">
                                        <div class="card-body contact-action">
                                            ...
                                            <div class="align-items-top">
                                                <div class="">
                                                    <div class="avatar avatar-xl avatar-rounded">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-21.jpg" alt="">
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-1 fw-semibold">
                                                            Balvinder Singh
